...
MODEL_PATH = "/home/f176/Documents/ai_model/anomaly_detector.pkl"  # Path to store the trained model
...
class LogAnomalyDetector:
    ...
    def process_log(self, log_request):
        ...
        if anomaly_score > self.anomaly_threshold:
            logging.warning(f"Anomaly in {log_request.get('service', 'unknown')} ({log_request.get('method', 'unknown')})")
    ...
    def load_model(self):
        """Loads the trained model from disk, or initializes a new one."""
